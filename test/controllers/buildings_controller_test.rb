...
class BuildingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building" do
    assert_difference("Building.count") do
      post buildings_url, params: { building: { adress: @building.adress, name: @building.name } }
    end
  ...
  test "should update building" do
    patch building_url(@building), params: { building: { adress: @building.adress, name: @building.name } }
